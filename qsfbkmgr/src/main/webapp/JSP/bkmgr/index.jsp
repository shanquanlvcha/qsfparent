...
<head>
    ...
    <meta name="keywords" content="骑士风后台管理系统">
    <meta name="description" content="骑士风后台管理系统">

    <!--[if lt IE 9]>
    <meta http-equiv="refresh" content="0;ie.html" />
    <![endif]-->

    <link rel="shortcut icon" href="../plus/favicon.ico">
                ...
                <ul class="nav" id="side-menu">
                    <li class="nav-header">
                        <div class="dropdown profile-element">
                            <span><img alt="image" class="img-circle" src="../plus/img/profile_small.jpg" /></span>
                        ...
                        <ul class="nav nav-second-level">
                            ...
                            <li>
                                ...
                                <ul class="nav nav-third-level">
                                    ...
                                    <li><a class="J_menuItem" href="ztree.jsp">ztree</a>
                                    </li>
                                </ul>
                            </li>
